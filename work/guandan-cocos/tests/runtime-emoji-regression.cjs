...
function findViolations (filePath) {
  ...
  // Imported user nicknames are content, not substitute UI icons. Restrict the exemption to this generated catalog.
  if (relativePath === 'assets/scripts/services/DefaultProfileCatalog.ts') {
    assert.match(fs.readFileSync(filePath, 'utf8'), /^\/\/ Generated by scripts\/sync-default-profiles\.mjs/)
    return []
  }
