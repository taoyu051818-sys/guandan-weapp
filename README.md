...
经典入口包含经典单局、不洗牌多炸单局和连打过 A；好友房支持经典、转蛋、八人双桌复式、机器人、落座调整和实时/延迟观战。商城仍是预览；16 人积分赛已有报名、取消报名、检录和三轮分桌流程。当前能力及退役边界见[开发基线](work/guandan-cocos/docs/CURRENT_CAPABILITIES.md)。代码与自动回归不等于真机验收或已部署状态。
