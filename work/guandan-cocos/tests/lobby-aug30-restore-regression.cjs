...
assert.match(view, /16人积分赛/, 'preserved lobby artwork must describe the active tournament')
assert.doesNotMatch(view, /筹备中/, 'do not present the active tournament as unavailable')
