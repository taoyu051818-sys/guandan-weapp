...
export class GameSession extends Component {
  ...
  public beginLocalGame (difficulty: Difficulty, mode: GameMode = 'standard'): void {
    this.snapshot = { ...this.snapshot, status: 'grouping', difficulty, gameMode: mode, isMultiplayer: false, roomId: null, myPlayerId: 'p1', dealerId: null, campaignProgress: mode === 'campaign' ? { chapter: 1, targetWins: 3, wins: 0, losses: 0, completed: false, failed: false } : null }
    this.commit()
  }
